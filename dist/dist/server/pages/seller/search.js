...
/* harmony default export */ var searchvue_type_script_lang_js_ = ({
  ...
  methods: {
    ...
    editUser(index, row) {
      ...
      this.$router.push(this.localePath(`/seller/create?sellerId=${row.sellerId}`));
    },
