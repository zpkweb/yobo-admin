...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/commodity/create.vue?vue&type=template&id=407e633b&scoped=true&
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('el-form',{ref:"form",attrs:{"model":_vm.form,"label-width":"108px"}},[_c('el-form-item',[(_vm.isCreate)?_c('el-button',{attrs:{"type":"primary","icon":"el-icon-circle-plus-outline"},on:{"click":function($event){return _vm.onSubmit('form')}}},[_vm._v("\n      "+_vm._s(_vm.$t('content.create'))+"\n    ")]):_c('el-button',{attrs:{"type":"primary","icon":"el-icon-check"},on:{"click":function($event){return _vm.onSubmit('form')}}},[_vm._v("\n      "+_vm._s(_vm.$t('content.update'))+"\n    ")]),_vm._v(" "),_c('el-button',{attrs:{"icon":"el-icon-check"},on:{"click":_vm.onMock}},[_vm._v("\n      "+_vm._s(_vm.$t('content.fill'))+"\n    ")]),_vm._v(" "),_c('el-button',{attrs:{"icon":"el-icon-circle-close"},on:{"click":function($event){return _vm.resetForm('form')}}},[_vm._v(_vm._s(_vm.$t('content.clear')))])],1),_vm._v(" "),_c('el-row',{attrs:{"gutter":20}},[_c('el-col',{attrs:{"span":6}},[_c('el-form-item',{attrs:{"label":_vm.$t('langname', { lang: _vm.$t('lang.zh'), name: _vm.$t('commodity.name') }),"prop":'name.zh-cn',"rules":{
          ...
          trigger: 'blur',
        }}},[_c('el-input',{attrs:{"type":"input","placeholder":_vm.$t('form.placeholder', { msg: _vm.$t('commodity.height.title') })},model:{value:(_vm.form.height),callback:function ($$v) {_vm.$set(_vm.form, "height", $$v)},expression:"form.height"}},[_c('template',{slot:"append"},[_vm._v("cm")])],2)],1)],1)],1),_vm._v(" "),_c('el-form-item',{attrs:{"label":_vm.$t('commodity.category'),"prop":'categorys[0].id',"rules":{
      required: false,
      message: ("" + (_vm.$t('commodity.category')) + (_vm.$t('form.noEmpty'))),
      trigger: 'change',
    }}},[_c('el-select',{attrs:{"placeholder":_vm.$t('form.selectPlaceholder', { msg: _vm.$t('commodity.category') }),"clearable":""},model:{value:(_vm.form.categorys[0].id),callback:function ($$v) {_vm.$set(_vm.form.categorys[0], "id", $$v)},expression:"form.categorys[0].id"}},_vm._l((_vm.categorys),function(item,index){return _c('el-option',{key:index,attrs:{"label":item['zh-cn'],"value":item.id}},[_c('span',[_vm._v(_vm._s(_vm.$t('lang.zh'))+"："+_vm._s(item['zh-cn'])+"，")]),_vm._v(" "),_c('span',[_vm._v(_vm._s(_vm.$t('lang.en'))+"："+_vm._s(item['en-us'])+"，")]),_vm._v(" "),_c('span',[_vm._v(_vm._s(_vm.$t('lang.ja'))+"："+_vm._s(item['ja-jp'])+"，")]),_vm._v(" "),_c('span',[_vm._v(_vm._s(_vm.$t('lang.es'))+"："+_vm._s(item['es-es']))])])}),1)],1),_vm._v(" "),_c('el-form-item',{attrs:{"label":_vm.$t('commodity.classification'),"prop":'classifications[0].id',"rules":{
      required: false,
      message: ("" + (_vm.$t('commodity.classification')) + (_vm.$t('form.noEmpty'))),
      trigger: 'change',
    }}},[_c('el-select',{attrs:{"placeholder":_vm.$t('form.selectPlaceholder', { msg: _vm.$t('commodity.classification') }),"clearable":""},model:{value:(_vm.form.classifications[0].id),callback:function ($$v) {_vm.$set(_vm.form.classifications[0], "id", $$v)},expression:"form.classifications[0].id"}},_vm._l((_vm.classifications),function(item,index){return _c('el-option',{key:index,attrs:{"label":item['zh-cn'],"value":item.id}},[_c('span',[_vm._v(_vm._s(_vm.$t('lang.zh'))+"："+_vm._s(item['zh-cn'])+"，")]),_vm._v(" "),_c('span',[_vm._v(_vm._s(_vm.$t('lang.en'))+"："+_vm._s(item['en-us'])+"，")]),_vm._v(" "),_c('span',[_vm._v(_vm._s(_vm.$t('lang.ja'))+"："+_vm._s(item['ja-jp'])+"，")]),_vm._v(" "),_c('span',[_vm._v(_vm._s(_vm.$t('lang.es'))+"："+_vm._s(item['es-es']))])])}),1)],1),_vm._v(" "),_c('el-form-item',{attrs:{"label":_vm.$t('commodity.material'),"prop":'materials[0].id',"rules":{
      required: false,
      message: ("" + (_vm.$t('commodity.material')) + (_vm.$t('form.noEmpty'))),
      trigger: 'change',
    }}},[_c('el-select',{attrs:{"placeholder":_vm.$t('form.selectPlaceholder', { msg: _vm.$t('commodity.material') }),"clearable":""},model:{value:(_vm.form.materials[0].id),callback:function ($$v) {_vm.$set(_vm.form.materials[0], "id", $$v)},expression:"form.materials[0].id"}},_vm._l((_vm.materials),function(item,index){return _c('el-option',{key:index,attrs:{"label":item['zh-cn'],"value":item.id}},[_c('span',[_vm._v(_vm._s(_vm.$t('lang.zh'))+"："+_vm._s(item['zh-cn'])+"，")]),_vm._v(" "),_c('span',[_vm._v(_vm._s(_vm.$t('lang.en'))+"："+_vm._s(item['en-us'])+"，")]),_vm._v(" "),_c('span',[_vm._v(_vm._s(_vm.$t('lang.ja'))+"："+_vm._s(item['ja-jp'])+"，")]),_vm._v(" "),_c('span',[_vm._v(_vm._s(_vm.$t('lang.es'))+"："+_vm._s(item['es-es']))])])}),1)],1),_vm._v(" "),_c('el-form-item',{attrs:{"label":_vm.$t('commodity.model'),"prop":'models[0].id',"rules":{
      required: false,
      message: ("" + (_vm.$t('commodity.model')) + (_vm.$t('form.noEmpty'))),
      trigger: 'change',
    }}},[_c('el-select',{attrs:{"placeholder":_vm.$t('form.selectPlaceholder', { msg: _vm.$t('commodity.model') }),"clearable":""},model:{value:(_vm.form.models[0].id),callback:function ($$v) {_vm.$set(_vm.form.models[0], "id", $$v)},expression:"form.models[0].id"}},_vm._l((_vm.models),function(item,index){return _c('el-option',{key:index,attrs:{"label":item['zh-cn'],"value":item.id}},[_c('span',[_vm._v(_vm._s(_vm.$t('lang.zh'))+"："+_vm._s(item['zh-cn'])+"，")]),_vm._v(" "),_c('span',[_vm._v(_vm._s(_vm.$t('lang.en'))+"："+_vm._s(item['en-us'])+"，")]),_vm._v(" "),_c('span',[_vm._v(_vm._s(_vm.$t('lang.ja'))+"："+_vm._s(item['ja-jp'])+"，")]),_vm._v(" "),_c('span',[_vm._v(_vm._s(_vm.$t('lang.es'))+"："+_vm._s(item['es-es']))])])}),1)],1),_vm._v(" "),_c('el-form-item',{attrs:{"label":_vm.$t('commodity.place'),"prop":'places[0].id',"rules":{
      required: false,
      ...
      trigger: 'change',
    }}},[_c('el-select',{attrs:{"placeholder":_vm.$t('form.selectPlaceholder', { msg: _vm.$t('commodity.shape') }),"clearable":""},model:{value:(_vm.form.shapes[0].id),callback:function ($$v) {_vm.$set(_vm.form.shapes[0], "id", $$v)},expression:"form.shapes[0].id"}},_vm._l((_vm.shapes),function(item,index){return _c('el-option',{key:index,attrs:{"label":item['zh-cn'],"value":item.id}},[_c('span',[_vm._v(_vm._s(_vm.$t('lang.zh'))+"："+_vm._s(item['zh-cn'])+"，")]),_vm._v(" "),_c('span',[_vm._v(_vm._s(_vm.$t('lang.en'))+"："+_vm._s(item['en-us'])+"，")]),_vm._v(" "),_c('span',[_vm._v(_vm._s(_vm.$t('lang.ja'))+"："+_vm._s(item['ja-jp'])+"，")]),_vm._v(" "),_c('span',[_vm._v(_vm._s(_vm.$t('lang.es'))+"："+_vm._s(item['es-es']))])])}),1)],1),_vm._v(" "),_c('el-form-item',{attrs:{"label":_vm.$t('commodity.specification'),"prop":'specifications[0].id',"rules":{
      required: false,
      message: ("" + (_vm.$t('commodity.specification')) + (_vm.$t('form.noEmpty'))),
      trigger: 'change',
    }}},[_c('el-select',{attrs:{"placeholder":_vm.$t('form.selectPlaceholder', { msg: _vm.$t('commodity.specification') }),"clearable":""},model:{value:(_vm.form.specifications[0].id),callback:function ($$v) {_vm.$set(_vm.form.specifications[0], "id", $$v)},expression:"form.specifications[0].id"}},_vm._l((_vm.specifications),function(item,index){return _c('el-option',{key:index,attrs:{"label":item['zh-cn'],"value":item.id}},[_c('span',[_vm._v(_vm._s(_vm.$t('lang.zh'))+"："+_vm._s(item['zh-cn'])+"，")]),_vm._v(" "),_c('span',[_vm._v(_vm._s(_vm.$t('lang.en'))+"："+_vm._s(item['en-us'])+"，")]),_vm._v(" "),_c('span',[_vm._v(_vm._s(_vm.$t('lang.ja'))+"："+_vm._s(item['ja-jp'])+"，")]),_vm._v(" "),_c('span',[_vm._v(_vm._s(_vm.$t('lang.es'))+"："+_vm._s(item['es-es']))])])}),1)],1),_vm._v(" "),_c('el-form-item',{attrs:{"label":_vm.$t('commodity.style'),"prop":'styles[0].id',"rules":{
      required: false,
      message: ("" + (_vm.$t('commodity.style')) + (_vm.$t('form.noEmpty'))),
      trigger: 'change',
    }}},[_c('el-select',{attrs:{"placeholder":_vm.$t('form.selectPlaceholder', { msg: _vm.$t('commodity.style') }),"clearable":""},model:{value:(_vm.form.styles[0].id),callback:function ($$v) {_vm.$set(_vm.form.styles[0], "id", $$v)},expression:"form.styles[0].id"}},_vm._l((_vm.styles),function(item,index){return _c('el-option',{key:index,attrs:{"label":item['zh-cn'],"value":item.id}},[_c('span',[_vm._v(_vm._s(_vm.$t('lang.zh'))+"："+_vm._s(item['zh-cn'])+"，")]),_vm._v(" "),_c('span',[_vm._v(_vm._s(_vm.$t('lang.en'))+"："+_vm._s(item['en-us'])+"，")]),_vm._v(" "),_c('span',[_vm._v(_vm._s(_vm.$t('lang.ja'))+"："+_vm._s(item['ja-jp'])+"，")]),_vm._v(" "),_c('span',[_vm._v(_vm._s(_vm.$t('lang.es'))+"："+_vm._s(item['es-es']))])])}),1)],1),_vm._v(" "),_c('el-form-item',{attrs:{"label":_vm.$t('commodity.technique'),"prop":'techniques[0].id',"rules":{
      required: false,
      message: ("" + (_vm.$t('commodity.technique')) + (_vm.$t('form.noEmpty'))),
      trigger: 'change',
    }}},[_c('el-select',{attrs:{"placeholder":_vm.$t('form.selectPlaceholder', { msg: _vm.$t('commodity.technique') }),"clearable":""},model:{value:(_vm.form.techniques[0].id),callback:function ($$v) {_vm.$set(_vm.form.techniques[0], "id", $$v)},expression:"form.techniques[0].id"}},_vm._l((_vm.techniques),function(item,index){return _c('el-option',{key:index,attrs:{"label":item['zh-cn'],"value":item.id}},[_c('span',[_vm._v(_vm._s(_vm.$t('lang.zh'))+"："+_vm._s(item['zh-cn'])+"，")]),_vm._v(" "),_c('span',[_vm._v(_vm._s(_vm.$t('lang.en'))+"："+_vm._s(item['en-us'])+"，")]),_vm._v(" "),_c('span',[_vm._v(_vm._s(_vm.$t('lang.ja'))+"："+_vm._s(item['ja-jp'])+"，")]),_vm._v(" "),_c('span',[_vm._v(_vm._s(_vm.$t('lang.es'))+"："+_vm._s(item['es-es']))])])}),1)],1),_vm._v(" "),_c('el-form-item',{attrs:{"label":_vm.$t('commodity.theme'),"prop":'themes[0].id',"rules":{
          required: false,
          message: ("" + (_vm.$t('commodity.theme')) + (_vm.$t('form.noEmpty'))),
          trigger: 'change',
        }}},[_c('el-select',{attrs:{"placeholder":_vm.$t('form.selectPlaceholder', { msg: _vm.$t('commodity.theme') }),"clearable":""},model:{value:(_vm.form.themes[0].id),callback:function ($$v) {_vm.$set(_vm.form.themes[0], "id", $$v)},expression:"form.themes[0].id"}},_vm._l((_vm.themes),function(item,index){return _c('el-option',{key:index,attrs:{"label":item['zh-cn'],"value":item.id}},[_c('span',[_vm._v(_vm._s(_vm.$t('lang.zh'))+"："+_vm._s(item['zh-cn'])+"，")]),_vm._v(" "),_c('span',[_vm._v(_vm._s(_vm.$t('lang.en'))+"："+_vm._s(item['en-us'])+"，")]),_vm._v(" "),_c('span',[_vm._v(_vm._s(_vm.$t('lang.ja'))+"："+_vm._s(item['ja-jp'])+"，")]),_vm._v(" "),_c('span',[_vm._v(_vm._s(_vm.$t('lang.es'))+"："+_vm._s(item['es-es']))])])}),1)],1),_vm._v(" "),_c('el-form-item',{attrs:{"label":_vm.$t('commodity.type'),"prop":'types[0].id',"rules":{
      required: false,
      message: ("" + (_vm.$t('commodity.type')) + (_vm.$t('form.noEmpty'))),
      trigger: 'change',
    }}},[_c('el-select',{attrs:{"placeholder":_vm.$t('form.selectPlaceholder', { msg: _vm.$t('commodity.type') }),"clearable":""},model:{value:(_vm.form.types[0].id),callback:function ($$v) {_vm.$set(_vm.form.types[0], "id", $$v)},expression:"form.types[0].id"}},_vm._l((_vm.types),function(item,index){return _c('el-option',{key:index,attrs:{"label":item['zh-cn'],"value":item.id}},[_c('span',[_vm._v(_vm._s(_vm.$t('lang.zh'))+"："+_vm._s(item['zh-cn'])+"，")]),_vm._v(" "),_c('span',[_vm._v(_vm._s(_vm.$t('lang.en'))+"："+_vm._s(item['en-us'])+"，")]),_vm._v(" "),_c('span',[_vm._v(_vm._s(_vm.$t('lang.ja'))+"："+_vm._s(item['ja-jp'])+"，")]),_vm._v(" "),_c('span',[_vm._v(_vm._s(_vm.$t('lang.es'))+"："+_vm._s(item['es-es']))])])}),1)],1),_vm._v(" "),_c('el-form-item',{attrs:{"label":_vm.$t('commodity.use'),"prop":'uses[0].id',"rules":{
      required: false,
      message: ("" + (_vm.$t('commodity.use')) + (_vm.$t('form.noEmpty'))),
      trigger: 'change',
    }}},[_c('el-select',{attrs:{"placeholder":_vm.$t('form.selectPlaceholder', { msg: _vm.$t('commodity.use') }),"clearable":""},model:{value:(_vm.form.uses[0].id),callback:function ($$v) {_vm.$set(_vm.form.uses[0], "id", $$v)},expression:"form.uses[0].id"}},_vm._l((_vm.uses),function(item,index){return _c('el-option',{key:index,attrs:{"label":item['zh-cn'],"value":item.id}},[_c('span',[_vm._v(_vm._s(_vm.$t('lang.zh'))+"："+_vm._s(item['zh-cn'])+"，")]),_vm._v(" "),_c('span',[_vm._v(_vm._s(_vm.$t('lang.en'))+"："+_vm._s(item['en-us'])+"，")]),_vm._v(" "),_c('span',[_vm._v(_vm._s(_vm.$t('lang.ja'))+"："+_vm._s(item['ja-jp'])+"，")]),_vm._v(" "),_c('span',[_vm._v(_vm._s(_vm.$t('lang.es'))+"："+_vm._s(item['es-es']))])])}),1)],1),_vm._v(" "),_c('el-form-item',{attrs:{"label":_vm.$t('commodity.color.title')}},[_c('el-row',{attrs:{"gutter":10}},[_vm._l((_vm.form.colors),function(item,index){return _c('el-col',{key:index,attrs:{"span":2}},[_c('el-form-item',{attrs:{"prop":'colors.' + index + '.name',"rules":{
            required: false,
            message: ("" + (_vm.$t('commodity.color.title')) + (_vm.$t('form.noEmpty'))),
            trigger: 'blur',
          }}},[_c('el-color-picker',{model:{value:(_vm.form.colors[index].name),callback:function ($$v) {_vm.$set(_vm.form.colors[index], "name", $$v)},expression:"form.colors[index].name"}})],1)],1)}),_vm._v(" "),_c('el-col',{attrs:{"span":2,"offset":1}},[_c('el-button',{attrs:{"icon":"el-icon-circle-plus-outline"},on:{"click":_vm.addColors}})],1)],2)],1),_vm._v(" "),_c('el-form-item',{attrs:{"label":_vm.$t('commodity.photo')}},[_c('el-upload',{attrs:{"file-list":_vm.form.photos,"action":((_vm.$config.origin) + "/api/upload/images"),"data":{ type: 'commodity' },"list-type":"picture-card","on-preview":_vm.uploadPreview,"on-remove":_vm.uploadRemove,"on-success":_vm.uploadSuccess}},[_c('i',{staticClass:"el-icon-plus"})]),_vm._v(" "),_c('el-dialog',{attrs:{"visible":_vm.dialogVisible},on:{"update:visible":function($event){_vm.dialogVisible=$event}}},[_c('img',{attrs:{"width":"100%","src":_vm.dialogImageUrl,"alt":""}})])],1),_vm._v(" "),_c('el-row',{attrs:{"gutter":20}},[_c('el-col',{attrs:{"span":24}},[_c('el-form-item',{attrs:{"label":_vm.$t('commodity.state.title'),"prop":'state'}},[_c('el-radio-group',{model:{value:(_vm.form.state),callback:function ($$v) {_vm.$set(_vm.form, "state", $$v)},expression:"form.state"}},[_c('el-radio',{attrs:{"label":0}},[_vm._v(_vm._s(_vm.$t('commodity.state.added')))]),_vm._v(" "),_c('el-radio',{attrs:{"label":1}},[_vm._v(_vm._s(_vm.$t('commodity.state.onsale')))]),_vm._v(" "),_c('el-radio',{attrs:{"label":2}},[_vm._v(_vm._s(_vm.$t('commodity.state.sold')))]),_vm._v(" "),_c('el-radio',{attrs:{"label":3}},[_vm._v(_vm._s(_vm.$t('commodity.state.offline')))])],1)],1)],1)],1),_vm._v(" "),_c('el-form-item',{attrs:{"label":_vm.$t('commodity.seller')}},[_c('el-row',{attrs:{"gutter":20}},[_c('el-col',{attrs:{"span":8}},[_c('el-input',{attrs:{"placeholder":_vm.$t('form.placeholder', { msg: _vm.$t('user.seller.id') })},model:{value:(_vm.form.sellerId),callback:function ($$v) {_vm.$set(_vm.form, "sellerId", $$v)},expression:"form.sellerId"}})],1)],1)],1)],1)}
var staticRenderFns = []


// CONCATENATED MODULE: ./pages/commodity/create.vue?vue&type=template&id=407e633b&scoped=true&
