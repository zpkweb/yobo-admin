...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/auth/identityList.vue?vue&type=template&id=7ca1bac8&
...
// CONCATENATED MODULE: ./pages/auth/identityList.vue?vue&type=template&id=7ca1bac8&
...
/* harmony default export */ var identityListvue_type_script_lang_js_ = ({
  ...
  async fetch() {
    const identityList = await this.$axios.$get('/api/admin/identityList'); // console.log('identityList', identityList.data)
  ...
  methods: {
    createIdentityList() {// console.log('createIdentityList')
    }
